...
public class Triangle extends ClosedCurve {
	...
	public Triangle(double side1, double side2, double side3) throws IllegalClosedCurveException {
		...
		if (x + y < z) {
			throw new IllegalClosedCurveException(
					"Illegal sizes for a triangle: " + side1 + ", " + side2 + ", " + side3);
	 ...
	 * 
	 * Triangle t = new Triangle(1.41421, 1.41421, 2); //System.out.println("Area:
	 * "+t.computeArea()); //System.out.println(""+(3560/256));
	 * //System.out.println(""+(3560-256*13)); System.out.println(""+(232/16));
	 * System.out.println(""+(232-16*(232/16))); System.out.println(""+(9*256 + 14 *
	 * 16 + 2)); System.out.println(""+(-5/2)+" "+ (-5%2));
	 * System.out.println(""+(35/4)); System.out.println(""+(35>>2)); byte x = 2;
	 * byte y = 3; //byte sum = x+ y; }
	 **/
