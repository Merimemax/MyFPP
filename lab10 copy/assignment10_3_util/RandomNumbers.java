...
public class RandomNumbers {
	...
	/**
	 * Chooses between 0 and 1. Picks 1 with probability p; picks 0 with probability
	 * 1-p. Modifies 0,1 to lower,upper.
	 */
	...
	public static void main(String[] args) {
		...
		/*
		 * int big = 1048000; int small = 1000; Random r = new Random(); BigInteger b =
		 * null; int max = 0; int min = 0; int above = 0; int below = 0;
		 * System.out.println(Math.pow(2,20));
		 * 
		 * for(int i = 0; i < 1000; ++i){ b = new BigInteger(20,r);
		 * 
		 * if(b.intValue() >big) { System.out.println(b.intValue()); ++above; }
		 * if(b.intValue()==(int)(Math.pow(2,20)-1)) ++max; if(b.intValue() < small) {
		 * System.out.println(b.intValue()); ++ below; } if(b.intValue() == 0) ++min; }
		 * System.out.println("max: "+max+" min: "+min+" above "+big+":"+above+" below "
		 * +small+":"+below);
		 * 
		 * /*
		 ...
		 * )); r = new Random();
		 * System.out.println(r.nextInt()+" "+r.nextInt()+" "+r.nextInt()+" "+r.nextInt(
		 * )); String s = "hello"; char c = s.charAt(0); char d = s.charAt(1);
